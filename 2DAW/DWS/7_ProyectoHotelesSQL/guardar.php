...
$borrarTabla = $conexion->exec('DROP TABLE hoteles');
$crearTabla = $conexion->exec('CREATE TABLE IF NOT EXISTS hoteles (
...
$añadirDatos = $conexion->exec("INSERT INTO hoteles (Nombre, Categoria, Habitantes, Poblacion, Direccion) VALUES 
