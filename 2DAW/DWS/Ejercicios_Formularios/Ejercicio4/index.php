...
try {
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($num2 == 0 && $_POST['calcular'] == "div") {
            throw new Exception("No se debe introducir 0 en el segundo paramentro de la division");
        }
...
?>
    ...
    <label for="numero1">Número 1: <input type="text" name="num1" id="num1" value="<?php echo isset($num1) ? $num1 : ''; ?>"></label><br><br>
        <label for="numero2">Número 2: <input type="text" name="num2" id="num2" value="<?php echo isset($num2) ? $num2 : '';?>"></label><br>
        <p>
